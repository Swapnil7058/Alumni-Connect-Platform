...
// import AlumniDashboard from "./AlumniDashboard"; // your current component
// import {
//   User,
//   Briefcase,
//   MessageSquare,
...
//       {/* Sidebar */}
//       <aside className="w-64 bg-linear-to-b from-[#1e3a8a] to-[#1e40af] text-white fixed h-screen flex flex-col shadow-xl">
